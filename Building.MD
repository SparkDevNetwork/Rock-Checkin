To perform a build, use the github action. If that fails with a signing issue then it is probably time to upload a new provisioning profile and certificate.
